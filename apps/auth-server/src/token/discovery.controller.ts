...
export class DiscoveryController {
  constructor() {
    ...
    if (!process.env.BETTER_AUTH_URL) {
      ...
      console.warn(
        '[DiscoveryController] BETTER_AUTH_URL is unset — advertising placeholder issuer in /.well-known/oauth-authorization-server. Set BETTER_AUTH_URL to silence this warning.',
      );
    }
  }
