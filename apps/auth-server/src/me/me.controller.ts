...
import { GetConsentQueryDto, RecordConsentDto } from './dto/record-consent.dto';
...
export class MeController {
  ...
  @Get('consent')
  getOutstandingConsent(@Req() req: Request, @Query() query: GetConsentQueryDto) {
    return this.me.getOutstandingConsent(callerBaId(req), query.appPublicId, resolveClientIp(req));
  }

  @Post('consent')
  @HttpCode(204)
  async recordConsent(@Req() req: Request, @Body() body: RecordConsentDto): Promise<void> {
