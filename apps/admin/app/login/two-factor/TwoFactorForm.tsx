  ...
  const trustDeviceCheckbox = (
    <label className="flex items-center gap-2 text-label-md text-[var(--muted-foreground)] cursor-pointer">
      <input
        ...
        className="h-4 w-4 rounded border-[var(--border)] accent-[var(--primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2"
      />
