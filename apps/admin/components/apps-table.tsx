...
import {
  ...
  DropdownMenuSeparator, DropdownMenuTrigger, Badge, Tooltip, TooltipTrigger, TooltipContent,
} from '@sassy-auth/ui'
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className="text-muted-foreground hover:text-primary focus-visible:ring-2"
                >
              ...
              <TooltipTrigger asChild>
                <DropdownMenuTrigger asChild onClick={(e) => e.stopPropagation()}>
                  <button
                    ...
                    className="flex h-7 w-7 items-center justify-center rounded hover:bg-muted focus-visible:ring-2"
                  >
