          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                {o.isPlatform && (
                  <Badge variant="secondary">{t("orgs.badges.platform")}</Badge>
                )}
              </div>
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <span className="tabular-nums">
          {t("orgs.fields.userCount", { count: row.original.userCount })}
        </span>
      ),
    },
    {
        ...
        >
          {[5, 10, 25, 50].map((n) => (
            <option key={n} value={n}>
              {t("orgs.pagination.pageSize", { count: n })}
            </option>
          ))}
        </select>
      </div>
