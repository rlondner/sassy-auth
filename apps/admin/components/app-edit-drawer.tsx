...
export function AppEditDrawer({ app, open, onOpenChange, onSuccess }: Props) {
  ...
  const [twoFactorTrustDays, setTwoFactorTrustDays] = React.useState<
    number | null
  >(app.twoFactorTrustDays ?? null);
  const [requireTwoFactor, setRequireTwoFactor] = React.useState<boolean>(
    app.requireTwoFactor ?? false,
  );
  ...
  const dirty =
    ...
    twoFactorTrustDays !== (app.twoFactorTrustDays ?? null) ||
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (callbackUrl !== (app.callbackUrl ?? ""))
      patch.callbackUrl = callbackUrl.trim() || null;
    if (twoFactorTrustDays !== (app.twoFactorTrustDays ?? null))
      patch.twoFactorTrustDays = twoFactorTrustDays;
    if (requireTwoFactor !== (app.requireTwoFactor ?? false))
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  onClick={() => void copy(app.publicId, "publicId")}
                >
