...
4. **Fetching Data:** To show the user list, the `admin` app (on the server) calls `GET http://localhost:3010/api/users` via the `getUsers()` helper, forwarding the session cookie.
